...
public class SharePreferenceMgr {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "evaluation_share_data";
    static SharedPreferences sp;
    static SharedPreferences.Editor editor;
    Context mcontext;

    public SharePreferenceMgr(Context context) {
    ...
    public static void putImage(String key, ImageView imageView) {
        ...
        // 将String保存shareUtils
        SharePreferenceMgr.put(key, imgString);
    }
    ...
    public static Bitmap getImage(String key, ImageView imageView) {
        String imgString = (String) SharePreferenceMgr.get(key, "");
        if (!imgString.equals("")) {
            // 利用Base64将我们string转换
